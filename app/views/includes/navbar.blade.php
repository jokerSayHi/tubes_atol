<nav>
    <div class="nav-wrapper green light-1">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li class="waves-effect waves-light tooltipped" data-position="bottom" data-delay="50" data-tooltip="Logout"><a href="/dashboard/logout"><i class="mdi-action-exit-to-app"></i></a></li>
      </ul>
    </div>
  </nav>